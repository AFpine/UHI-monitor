...
import static com.example.heatislandmap.CalcAverageTemp.slatList;
import static com.example.heatislandmap.CalcAverageTemp.slngList;
import static com.example.heatislandmap.CalcAverageTemp.sTempList;
...
public class MainActivity extends AppCompatActivity{
    ...
    private String jsonLat;
    private String jsonLng;
    ...
    private void loadData() {
        ...
        jsonLat = gson.toJson(slatList);
        jsonLng = gson.toJson(slngList);
        jsonTemp = gson.toJson(sTempList);

        myWebView.loadUrl("javascript:loadMapData('" + jsonDataOfArea + "', '" + HEAT_ISLAND_TEMP1 + "', '" + HEAT_ISLAND_TEMP2 + "', '" + HEAT_ISLAND_AVG +
                "', '" + jsonDataofHumid + "', '" + jsonDataofFeel + "', '" + jsonLat + "', '" + jsonLng + "', '" + jsonTemp + "')");
